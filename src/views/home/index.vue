<template>
  <div>
      ...
      <div class="carousel-inner">
        <div class="container">
          <div class="carousel-caption">
            <h1 style="font-weight: 700;font-size: 38px;text-shadow: black 0.1em 0.1em 0.2em">SMBE Regional Evolutionary Genetics Meeting</h1>
            <h1 style="font-weight: 600;font-size: 50px;text-shadow: black 0.1em 0.1em 0.2em">Shanghai 2023</h1>
            <h2 style="font-weight: 600;font-size: 40px;text-shadow: black 0.1em 0.1em 0.2em">2023/10/20 - 2023/10/22</h2>
            <p><router-link class="btn btn-lg btn-primary" to="/contact">Contact us</router-link></p>
          </div>
        </div>
        <div class="carousel-item active">
          <img width="100%" height="100%" src="@/assets/img/home/1.jpg"/>
        </div>
        <div class="carousel-item">
          <img width="100%" height="100%" src="@/assets/img/home/2.jpg"/>
        </div>
        <div class="carousel-item">
          <img width="100%" height="100%" src="@/assets/img/home/3.jpg"/>
        </div>
      </div>
    ...
    <div class="container" style="margin-top: 3rem">
      <div style="border-radius: 10px; background-color: rgb(248,249,250);padding: 2rem 3rem">
        <h2 class="display-5 fw-bold">Introduction</h2>
    ...
    <div class="container px-4 py-5" id="featured-3" style="padding-bottom: 0 !important;">
      <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
        ...
        <div class="feature col">
          <h3 class="fs-2">Information</h3>
          <p>Information available soon</p>

          <button type="button" class="btn btn-outline-primary" disabled>View PDF</button>
        </div>
        <div class="feature col">
          <h3 class="fs-2">Abstract</h3>
          <p>Abstracts available soon</p>
          <button type="button" class="btn btn-outline-primary" disabled>View PDF</button>
        </div>
      </div>
    </div>
